...
const MovieCard = ({title,movie,movieId}) => {
  ...
  return (
    <Link to={`/watch/${movieId}`} className=' min-w-[200px] w-[200px]  h-[380px]  rounded-lg shadow-lg  flex flex-col items-center justify-between bg-black hover:bg-amber-900 transition-all duration-300 cursor-pointer overflow-hidden'>
